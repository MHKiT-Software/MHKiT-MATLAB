...
% calculate the mean square sound pressure spectral density (SPSD) of the timeseries 
% using |sound_pressure_spectral_density|. This splits the timeseries into windows 
...
% stored as an attribute of the measurement timeseries, and a window size (“bin_length”) 
% in seconds as input.
% 
...
% Here we use the function in the following codeblock to read in a CSV file created 
...
% 
% In the following codeblock, we use the same plotting function as above, but 
...
% a mix of mild flow noise below 20 Hz and low frequency attenutation below ~50 
