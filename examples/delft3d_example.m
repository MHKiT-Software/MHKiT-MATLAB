...
% in meters, the value of vairable in meters per second and the run time of the 
...
%% 
% In MHKiT-MATLAB we typically return a structure containg the results from 
...
% outputs.
% 
% The limits |max_plot_vel| and |min_plot_vel| define the vizualization boundaries 
...
% of tubulent intesity normal to turbine (y-waterdepth cross section) n turbine 
