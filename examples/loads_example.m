...
% us a visual. Using the statplotter function, we can quickly create a standard
...
% with the bin_stats function from the loads module shown below. A warning message
...
% data and corresponding standard deviations as inputs to the binplotter function.
