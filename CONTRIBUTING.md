...
All public functions **must** have properly formatted docstrings. This is enforced by automated CI checks.

#### Simple Function Template

```matlab
function Hm0 = significant_wave_height(S, frequency)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Calculate significant wave height from spectral density
%
% Parameters
% ------------
%   S : vector or matrix
%       Spectral density values [m^2/Hz]
%   frequency : vector
%       Frequency bins [Hz]
%
% Returns
...
Hm0 = 4 * sqrt(trapz(frequency, S));

end
```

#### Complex Function Template (Struct Inputs/Outputs)

```matlab
function mspl = band_sound_pressure_level(spsd, octave, base, fmin, fmax)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Calculate band-averaged sound pressure levels from spectral density
%
%   Computes sound pressure level in fractional octave bands from
...
%   octave : int
%       Octave subdivision (1 = full octave, 3 = third-octave)
%   base : int (optional)
%       Octave base subdivision (default: 2 for true octave)
...
% ---------
%   mspl : struct
%       Sound pressure level [dB re 1 uPa] indexed by time and frequency
