...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Calculates wave energy period (Te) [seconds] from power spectral density (PSD)
%
% Parameters
% ------------
...
% Returns
% ---------
% Te : double, column vector, table, or timetable [s]
%   Wave energy period, one value per spectrum. Matches the container
...
%         01-Jan-2025 00:00:00       6.9209    
%         01-Jan-2025 00:30:00       6.8977    
%         01-Jan-2025 01:00:00        6.715    
%         :
%         31-Dec-2025 22:30:00        8.712    
%         31-Dec-2025 23:00:00       9.2423    
%         31-Dec-2025 23:30:00       8.8095
%
...
[spectrum, frequency, time, input_style, remaining] = mhkit_standardize_spectrum_input(S, 'energy_period', varargin{:});

% Compute on primitive numeric arrays only, following MHKiT-Python convention.
if isempty(remaining)
    m0 = frequency_moment(spectrum, 0, frequency);
    m_neg1 = frequency_moment(spectrum, -1, frequency);
else
    m0 = frequency_moment(spectrum, 0, frequency, remaining{1});
    m_neg1 = frequency_moment(spectrum, -1, frequency, remaining{1});
end
