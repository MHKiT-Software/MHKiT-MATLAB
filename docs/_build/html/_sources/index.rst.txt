.. MHKiT-Matlab documentation master file
...
The MHKiT-Matlab repository is located at https://code.primre.org/mhkit/matlab.
...
.. raw:: html
    ...
    <embed>
        <button onclick="location.href='http://www.google.com'" type="button">
         Return to the MHKiT Code Hub documentation</button>
        <br/><br/>
    </embed>
